...
function() {
    var _getHash = function() {
        ...
        return index != -1 ? _ec(_dc(_l.href.substr(index + 2))) : ""
    };
    ...
    if (_supported) {
        ...
        if ((!_supported && _l.href.indexOf("#!") != -1) || (_safari && _version < 418 && _l.href.indexOf("#!") != -1 && _l.search != "")) {
            _d.open();
            _d.write('<html><head><meta http-equiv="refresh" content="0;url=' + _l.href.substr(0, _l.href.indexOf("#!")+1) + '" /></head></html>');
            _d.close()
        } else {
            _track()
        }
    ...
    this.onExternalChange = null; (function() {
        var _args;
