...
function activateWheelListener()
{
		
	this.deactivateWheelListener();
	swfmacmousewheel.addScrollEventListener();
}
		
function deactivateWheelListener()
{		
	if (window.addEventListener)
	{
		swfmacmousewheel.removeScrollEventListener();
	}
}
...
var swfmacmousewheel = function()
{
	...
	return {
		...
		*/
		...
		{
			window.removeEventListener('DOMMouseScroll', deltaDispatcher, false);
