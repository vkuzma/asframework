...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MyContentType'
        db.create_table('page_page_mycontenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mycontenttype_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('application', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('page', ['MyContentType'])


    def backwards(self, orm):
        
        # Deleting model 'MyContentType'
        db.delete_table('page_page_mycontenttype')


    models = {
        'page.mycontenttype': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'MyContentType', 'db_table': "'page_page_mycontenttype'"},
            'application': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mycontenttype_set'", 'to': "orm['page.Page']"}),
